	...
	for service_num in service_num_arr:
		...
		for load in load_arr:
			...
			for ECN_scheme in ECN_scheme_arr:
				...
				directory_name = 'pias_diffserv_'+specialStr+switchAlg+'_'+transport+'_scheme_'+str(ECN_scheme)+'_load_'+str(int(load*10))+'_service_'+str(service_num)
