...
Queue/PrioWfq set wfq_queue_num_ 2
Queue/PrioWfq set mean_pktsize_ [expr $packetSize+40]
Queue/PrioWfq set port_thresh_ $K
Queue/PrioWfq set marking_scheme_ $marking_scheme
...
Queue/PrioWfq set link_capacity_ $lineRate
Queue/PrioWfq set debug_ true
...
$ns simplex-link $switch $receiver $lineRate [expr $RTT/4] PrioWfq
